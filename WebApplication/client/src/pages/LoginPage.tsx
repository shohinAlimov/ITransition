        ...
        <div className="flex flex-col justify-center lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              <form className="mx-auto max-w-xs mb-10">
                <input
                ...
                />
                <input
                  className="mb-5 w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                  type="password"
